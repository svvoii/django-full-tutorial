...
from django.contrib.auth.forms import UserCreationForm, AuthenticationForm # This is a built-in form that we can use to create a new user
...
def register_view(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			login(request, form.save()) # Log the user in
